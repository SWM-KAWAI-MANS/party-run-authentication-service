...
public class MemberAuthorizationRegistry implements AuthorizationRegistry {
    ...
    @Override
    public AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry match(
            AuthorizeHttpRequestsConfigurer<HttpSecurity>
                    .AuthorizationManagerRequestMatcherRegistry
                    r) {
        return r.requestMatchers(HttpMethod.POST, "/auth").permitAll()
