...
class AuthControllerTest extends RestDocumentTest {
    ...
    class 정상적인_idToken이_주어졌을_때 {
        ...
        JwtToken expected = new JwtToken("3Y2NiZmIwMDg5NzQ1ZDA1ZiIs.eyJpZCI6IjY0ODIiZmIwMDg5NzQ1ZD4NTc3Y2NiZmIwMDg5NzQ1ZDA1ZiIsImV4cCI6MTY4NzMwNzY1NH0.4Jka7hW3NWESLOOmNj-_XK-Yf9TKoxW42Vq_aMO6jB_uIp6-mpdamJ43F7ADu57RTkbCnMJ8b06TA5kLEIlJqQ",
    ...
    class idToken이_잘못된_형식이라면 {
        ...
        @DisplayName("BadRequest를 응답한다.")
        void returnException() throws Exception {
            given(authService.authorize(invalidIdTokenRequest.idToken())).willThrow(new IllegalIdTokenException(""));
    ...
    class 정상적인_refreshToken이_주어졌을_떄 {
        ...
        AccessTokenResponse expected = new AccessTokenResponse("Y2NiZmIwMDg5IUzUxMiJ9.eyJpZCI6IjY0ODI4NTc3Y2NiZmIwMDg5NzQ1ZDA1ZiIsImV4cCI6MTY4NzMwNzY1NH02Vq_aMO6jB_uIp6-mpda8b06TA5kLEIlJqQ");
    ...
    class refreshToken이_잘못된_형식이라면 {
        ...
        @DisplayName("BadRequest를 응답한다.")
        void returnException() throws Exception {
            given(authService.refreshAccessToken(refreshToken)).willThrow(new IllegalIdTokenException("idToken"));
            ResultActions actions =
                    mockMvc.perform(
                            post("/auth/access")
                                    .contentType(MediaType.APPLICATION_JSON)
